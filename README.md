...
![](https://github.com/moful-tester/workshop-crossing-the-bridge-test-user/actions/workflows/0-crossing-prologue.yaml/badge.svg)
![](https://github.com/moful-tester/workshop-crossing-the-bridge-test-user/actions/workflows/1-codespace-awakening.yaml/badge.svg)
![](https://github.com/moful-tester/workshop-crossing-the-bridge-test-user/actions/workflows/2-summon-first-oracle.yaml/badge.svg)
![](https://github.com/moful-tester/workshop-crossing-the-bridge-test-user/actions/workflows/3-call-second-oracle.yaml/badge.svg)
![](https://github.com/moful-tester/workshop-crossing-the-bridge-test-user/actions/workflows/4-bridge-synthesis.yaml/badge.svg)
![](https://github.com/moful-tester/workshop-crossing-the-bridge-test-user/actions/workflows/5-bridge-farewell.yaml/badge.svg)
...
> [!NOTE]
> Estado atual: <!--WORKSHOP_STATUS-->🟢 O Codespace guardião aguarda seu despertar. Abra um Codespace e retorne a esta issue para continuar.<!--END_WORKSHOP_STATUS-->
...
4. Abra a issue indicada pelo botão **Start Workshop** para seguir a narrativa. Quando o sinal for dado, crie um Codespace para prosseguir.
   ...
   <a id="start-workshop" href="https://github.com/moful-tester/workshop-crossing-the-bridge-test-user/issues/1">
